...
const NavbarOnHome = () => {
  ...
  const [handb, setHandb] = useState(false);
  ...
  return (
    <>
      <div className={`navDiv ${navTheme ? "navScrollTop" : ""}`}>
        ...
        <div onClick={()=>{handb ? setHandb(false):setHandb(true)}} className="burgerMenu">
          <span className="burgerLine"></span>
          <span className="burgerLine"></span>
          <span className="burgerLine"></span>
        </div>
        <div className={`navigations ${handb ? "navigationActive":""}`}>
